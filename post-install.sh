...
cd eth-proxy
rm eth-proxy.conf
wget https://raw.githubusercontent.com/TheMiningKing/ethereum-miner-aloha/master/scripts/eth-proxy.conf
...
cd /home/$USERNAME
wget https://raw.githubusercontent.com/TheMiningKing/ethereum-miner-aloha/master/scripts/geth-start.sh
wget https://raw.githubusercontent.com/TheMiningKing/ethereum-miner-aloha/master/scripts/dwarfpool-start.sh
wget https://raw.githubusercontent.com/TheMiningKing/ethereum-miner-aloha/master/scripts/go.sh
chmod 774 *.sh
